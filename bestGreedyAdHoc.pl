...
has_node_selected([_,N1,N2,_],ListaNodi):-
	nth1(N1,ListaNodi,Val1,_),
	nth1(N2,ListaNodi,Val2,_),
	((Val1==1;Val2==1)
		->true
...
Se l'arco è ammissibile e anche adiacente, viene preso, altrimenti viene inserito in una lista controllati che viene passata alla funzione cerca_arco, in modo che essa sappia di aver già
